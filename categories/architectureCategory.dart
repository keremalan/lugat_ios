...
class ArchitectureCategory extends StatefulWidget {
  const ArchitectureCategory({Key? key}) : super(key: key);

  @override
  _ArchitectureCategoryState createState() => _ArchitectureCategoryState();
}

class _ArchitectureCategoryState extends State<ArchitectureCategory> {
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              CategoryCard(
                categoryImage: 'https://www.upload.ee/image/13838969/architecture.png',
                categoryName: 'Mimari',
                categoryDailyTerm: 'Fanlights',
