...
class UICategory extends StatefulWidget {
  const UICategory({Key? key}) : super(key: key);

  @override
  _UICategoryState createState() => _UICategoryState();
}

class _UICategoryState extends State<UICategory> {
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              CategoryCard(
                categoryImage: 'https://www.upload.ee/image/13844724/ui.png',
                categoryName: 'UI',
                categoryDailyTerm: 'Bento Menu',
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "Teriminiz incelenmek üzere moderatörlere gönderilmiştir. Katkınız için Lugat topluluğu adına teşekkür ederiz.",
